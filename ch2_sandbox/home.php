...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) :
			...
			?>
			<section class="block hero height-<?php the_field( 'height', get_option('page_for_posts', true) ); ?>" style="background-color: gray; background-image: url('<?php echo $background; ?>');">
