...
<section
        class="block image_slider default-<?php the_sub_field( 'slider_default_background' ); ?> accent-<?php the_sub_field( 'slider_accent_color' ); ?>">
        ...
        <div class="inner-block-wrapper"> <!-- probably extend with row or -->
            ...
            <div class="image_slider--content">
                <!--follow this pattern for fields, that way their space is not allocated if the field is empty and we do not have weird empty markup everywhere-->
							...
							<?php if ( get_sub_field( 'slider_heading' ) ): ?>
                  <h3 class="image_slider--title"> <?php the_sub_field( 'slider_heading' ); ?></h3>
							<?php endif; ?>

							<?php if ( get_sub_field( 'slider_copy' ) ): ?>
                  <div class="image_slider--copy"> <?php the_sub_field( 'slider_copy' ); ?></div>
							<?php endif; ?>
